...
export default function Create({ errors, options }) {
    ...
    const storeWali = async (e) => {
        e.preventDefault();

        await router.post('/wali', {
            name: name,
            student_id: student
        })
    };
                            ...
                            <div className="max-w-sm mx-auto p-4">
                                <form onSubmit={storeWali}>
                                    ...
                                    <div className="mt-1">
                                        ...
                                        placeholder="Massukan Nama Orang Tua"
                                        />
                                    </div>
                                    {errors.name && (
...
<div>
                                        ...
                                        <div className="mt-1">
                                            <select name="student" id="student" onChange={(e) => setStudent(e.target.value)} className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2.5 border">
