    ...
    return (
        ...
        <AuthenticatedLayout>            
            ...
            <div className='flex justify-start items-center px-3 pt-5'>
                <Link href={ route('wali.create') } className='bg-gray-900 rounded-lg py-2 px-3 text-white'>
                    Create
                </Link>    
            </div>
                            ...
                            <tr>
                                ...
                                <tr className="hover:bg-gray-100 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">
                                        <Link rel="stylesheet" href={ route('wali.edit', data.id) } className='py-2 px-3 bg-blue-500 rounded-xl'>Edit</Link>
